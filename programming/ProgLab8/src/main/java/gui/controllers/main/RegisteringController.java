...
public class RegisteringController implements Initializable, TextDrawable {
    @FXML
    ...
    public void drawText() {
        ...
        registerLabel.setText(LocaleManager.getString("register"));
    ...
    public void authorize(ActionEvent actionEvent) throws IOException {
        try {
            ...
            SceneControl.getBackendInteractor().register(nameField.getText(), passwordField.getText());
